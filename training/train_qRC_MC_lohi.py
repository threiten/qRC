...
def main(options):
    ...
    qRC = QReg_C.quantileRegression_chain(options.year,options.workDir)
    qRC.ShowerShapes = ['probeEtaWidth','probeSigmaIeIe','probePhiWidth','probeR9','probeS4','probeCovarianceIetaIphi']
