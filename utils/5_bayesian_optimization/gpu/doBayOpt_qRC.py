...
def main(options):
    df = pd.read_hdf('/work/gallim/dataframes/2018_flashgg_UNCORRECTED/MIX_df_mc_EB_test_corr_clf_5M.h5',columns=['probePt','probeScEta','probePhi','rho','probeCovarianceIeIp','probeS4','probeR9','probePhiWidth','probeSigmaIeIe','probeEtaWidth','probeCovarianceIeIp_corr','probeS4_corr','probeR9_corr','probePhiWidth_corr','probeSigmaIeIe_corr','probeEtaWidth_corr','probePhoIso','probeChIso03','probeChIso03worst','probePhoIso_corr','probeChIso03_corr','probeChIso03worst_corr'])
