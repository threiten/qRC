...
def main(options):
    ...
    # Since it was too difficult to stick to a single naming convention:
    # for MC:
    # probePhoIdMVA = newPhoIDcorrAllFinal
    # probePhoIdMVA_uncorr = newPhoID
    # for data:
    # probePhoIdMVA = newPhoID
    # probePhoIdMVA_uncorr = newPhoID
    df_in['probePhoIdMVA'] = df_in['newPhoIDcorrAllFinal']
    df_in['probePhoIdMVA_uncorr'] = df_in['newPhoID']
    df_data['probePhoIdMVA'] = df_data['newPhoID']
    df_data['probePhoIdMVA_uncorr'] = df_data['newPhoID']
    df1['probePhoIdMVA'] = df1['newPhoIDcorrAll']
    df1['probePhoIdMVA_uncorr'] = df1['newPhoID']
    df2['probePhoIdMVA'] = df2['newPhoIDcorrAll']
    df2['probePhoIdMVA_uncorr'] = df2['newPhoID']
